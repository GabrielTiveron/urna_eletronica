...
{
  string aux = colocar_aspas(NM_CANDIDATO);
  ...
  cout << Candidatos[i].get_NM_URNA_CANDIDATO() << "\t" << Candidatos[i].get_NM_PARTIDO() << endl;
  cout << Candidatos[cand].get_NM_URNA_CANDIDATO() << "\t" << Candidatos[cand].get_NM_PARTIDO()  << endl;
